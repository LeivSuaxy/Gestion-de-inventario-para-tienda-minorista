...
urlpatterns = [
      ...
      path('insertproduct/', views.insert_product_in_database, name='insert_product'),
      path('updateproduct/', views.update_product_in_database, name='update_product'),
      path('purchaseproducts/', views.purchased_products, name='purchase_products'),
